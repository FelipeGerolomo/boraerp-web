...
export function mapProductDetailToFormValues(
  ...
  return {
    ...
    netWeightKg: detail.general?.dimensions?.netWeightKg ?? 0,
    grossWeightKg: detail.general?.dimensions?.grossWeightKg ?? 0,
    packageTypeCode: detail.general?.dimensions?.packageTypeCode ?? "",
    widthCm: detail.general?.dimensions?.widthCm ?? 0,
    heightCm: detail.general?.dimensions?.heightCm ?? 0,
    lengthCm: detail.general?.dimensions?.lengthCm ?? 0,
